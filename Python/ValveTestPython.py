...
def sendCommand(td):
    ...
    while n < numLoops:
        ...
        if waitingForReply == False:
            ...
            print ("Sent from PC -- COMMAND STR " + teststr)
...
#Wait for the arduino to say it is ready
waitForArduino()



#Commands should be in the form <LED1,800,0.7>
while True:
    cmdArr = []
    cmdArr.append(input("Enter a command: "))
    sendCommand(cmdArr)